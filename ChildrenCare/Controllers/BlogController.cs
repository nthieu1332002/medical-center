...
namespace ChildrenCare.Controllers
{
    public class BlogController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> BlogManagement(int? page)
        {
        ...
        public async Task<IActionResult> BlogList()
        {
            ...
            ViewBag.Categories = await _categoryService.GetAllCategories();
            //foreach (GetBlogListResponseDTO blog in ViewBag.Blogs)
            //{
            //    var user = await _userManager.FindByIdAsync(blog.AuthorUserId.ToString());
            //    blog.Author = user;
            //}
        ...
        {
            ViewBag.Categories = await _categoryService.GetAllCategories();
            ViewBag.Blog = await _blogService.GetBlogAsync(id);
            return View();
        }
        ...
        public async Task<IActionResult> UpdateBlog(UpdateBlogRequestDTO dto)
        {
            ...
            // if (!ModelState.IsValid)
            // {
            //     return RedirectToAction("UpdateBlog", "Blog");
            // }
